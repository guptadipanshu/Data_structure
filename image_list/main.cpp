...
{/*
	...
	*/	
	...
	for (int i = 1; i <= 20; i++)
		list3.insertBack(i);
	cout << "[Before reverse custom]: " << list3 << endl;
	list3.reverse();
	cout << "[After reverse custom]: " << list3 << endl;
}
...
void testReverseNth()
{
	...
	*/List<int> list3;
	...
	//list3.insertBack(i);
	//cout << "[reverseNth custom]: " << list3 << endl;
	//list3.reverseNth(37);
	//cout << "[reverseNth custom]: " << list3 << endl;
...
void testSplit()
{
	...
	for (int i = 1; i <= 5; i++)
	list3.insertBack(i);
	List<int> list2=list3.split(2);
	cout << "[split custom]: " << list3 <<"\nlist "<<list2<< endl;
	*/
}
